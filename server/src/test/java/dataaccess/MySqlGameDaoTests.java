...
class MySqlGameDaoTests {
    ...
    void updateGameNegative() throws DataAccessException {
        int gameID = testDataBase.createGame("testGame");
        assertThrows(dataaccess.DataAccessException.class, () -> testDataBase.updateGameUsername("testUser", ChessGame.TeamColor.WHITE, 0),
                "Should throw dataaccess.DataAccessException for bad request");
    }
}